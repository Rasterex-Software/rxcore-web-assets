...
declare namespace PDF {
  ...
  namespace actions {
    ...
    export import LaunchAction = __internal__.LaunchAction;
  ...
  namespace common {
    export import FileSpec = __internal__.FileSpec;
  }

  namespace bookmark {
    export import BookmarkDestination = __internal__.BookmarkDestination;

    export import BookmarkFontStyle = __internal__.BookmarkFontStyle;

    export import BookmarkRelationship = __internal__.BookmarkRelationship;

    export import BookmarkZoomMode = __internal__.BookmarkZoomMode;
  }
  ...
  namespace constant {
    namespace constant {
      export import Line_Type = __internal__.Line_Type;
    }
...
declare namespace bookmark {
  export import AddBookmarkEvent = __internal__.AddBookmarkEvent;

  export import AddBookmarkOptions = __internal__.AddBookmarkOptions;

  export import BookmarkData = __internal__.BookmarkData;

  export import BookmarkDataService = __internal__.BookmarkDataService;

  export import BookmarkProperties = __internal__.BookmarkProperties;

  export import DeleteBookmarkEvent = __internal__.DeleteBookmarkEvent;

  export import MoveBookmarkEvent = __internal__.MoveBookmarkEvent;

  export import PasteCutBookmarkInfo = __internal__.PasteCutBookmarkInfo;

  export import UpdateBookmarkPropertiesEvent = __internal__.UpdateBookmarkPropertiesEvent;

  export import BookmarkTextColor = __internal__.BookmarkTextColor;
}
...
declare namespace interfaces {
  ...
  export import MultimediaPlayer = __internal__.MultimediaPlayer;
