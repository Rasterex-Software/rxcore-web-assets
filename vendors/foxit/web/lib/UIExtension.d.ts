...
export declare namespace bookmark {
  export import BookmarkTreeComponent = __internal__.BookmarkTreeComponent;

  export import BookmarkUIService = __internal__.BookmarkUIService;
}
...
export declare namespace components {
  namespace widgets {
    ...
    export import TreeComponent = __internal__.TreeComponent;

    export import TreeNodeComponent = __internal__.TreeNodeComponent;

    export import TreeNodeData = __internal__.TreeNodeData;
  }
...
export declare namespace controllers {
  ...
  export import CancelCreatingDrawingController = __internal__.CancelCreatingDrawingController;

  export import CancelCreatingMeasurementController = __internal__.CancelCreatingMeasurementController;

  export import CompleteCreatingDrawingController = __internal__.CompleteCreatingDrawingController;
